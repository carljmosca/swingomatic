...
public class HttpClientWrapper {
	 ...
	 * Post
	 *
	 * @param adiXML the adi xml
	 * @param adiUserName the user name
	 * @param adiPassword the password
	 * @param adiURL the adi url
	 * @param requestType the request type
	 * @throws ADIRequestException the aDI service request exception
	 */
	public String post(final String url, final String data)
		...
		try {
			...
			try {
				...
				LOGGER.log(Level.SEVERE,"Error occured shutting down HTTP client",e);
				/* No Op */
			}
		}
